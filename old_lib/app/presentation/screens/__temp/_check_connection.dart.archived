          ...
          case SetupConnectionState.none:
            widget = Column(
              ...
              children: [
                ...
                Text(
                  "Pininizi resetlemek için heethings hesabınıza giriş yapmanız gerekiyor. Hesabınıza giriş yapabilmeniz için internet bağlantısına ihtiyacınız var. Lütfen bağlantı yöntemini seçerek internet bağlantınızı sağlayınız.",
              ...
              children: [
                ...
                Container(
                  ...
                  child: OutlinedButton(
                      onPressed: screenState == SetupConnectionState.connected
                          ? () {
                              Get.offAndToNamed(Routes.heetingsLogin);
                            }
                          : null,
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
