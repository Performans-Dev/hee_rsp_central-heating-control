...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_libserialport/flutter_libserialport.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/libserialport/libserialport.framework"
