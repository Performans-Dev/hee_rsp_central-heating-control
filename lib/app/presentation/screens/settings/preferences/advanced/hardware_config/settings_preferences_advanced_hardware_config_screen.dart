                                    ...
                                    itemBuilder: (context) => [
                                      ...
                                      PopupMenuItem(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (result != null) {
                                            await dc.changeGapValue(hw,
                                                double.tryParse(result) ?? 0);
                                            if (context.mounted) {
                                              DialogUtils.snackbar(
                                                context: context,
                                        ...
                                        onTap: () async {
                                          final result =
                                              await OnScreenKeyboard.show(
                                                  ...
                                                  type: OSKInputType.number);
                                          if (result != null) {
                                            await dc.changeCoefficientValue(hw,
                                                double.tryParse(result) ?? 1);
                                            if (context.mounted) {
                                              DialogUtils.snackbar(
                                                context: context,
