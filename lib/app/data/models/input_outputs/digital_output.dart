...
class DigitalOutput {
  ...
  DigitalOutput copyWith({
    ...
    return DigitalOutput(
      ...
      queuedValue: queuedValue ?? this.queuedValue,
    );
  }
  ...
  @override
  String toString() {
    return 'DigitalOutput(id: $id, hwId: $hwId, pinIndex: $pinIndex, name: $name, value: $value, queuedValue: $queuedValue)';
  }
